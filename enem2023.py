...
Original file is located at
    https://colab.research.google.com/drive/1t9DxT8-Whjv_ekRodS9qw2buJVK1Okgs
"""
...
dados = pd.read_csv('/content/drive/My Drive/MICRODADOS_ENEM_2023.csv',encoding='ISO-8859-1', sep=';')
dados #aqui estou lendo meu CSV

dados.shape #aqui eu estou vendo quantas linhas e quantas colunas eu tenho

dados.columns #exibe todas as colunas do meu SVG

dados.head() #mostra os 5 primeiros dados

dados['NU_NOTA_COMP1'].value_counts()



#plt.rcParams['agg.path.chunksize'] = 10000
dados['NU_NOTA_COMP1'].plot(kind='hist')
...
plt.title('Maiores Notas por Matéria no ENEM 2023', fontsize=14)
