...
Original file is located at
    https://colab.research.google.com/drive/15M6RnoT6aW2BJKvNJS2Cam_J8iisSZnu
"""
...
total_lines = sum(1 for line in open('/content/drive/My Drive/MICRODADOS_ENEM_2019.csv',encoding='ISO-8859-1'))

# Passo 2: Calcule 90% do total
lines_to_read = int(total_lines * 0.85)

# Passo 3: Leia apenas as linhas desejadas
dados = pd.read_csv('/content/drive/My Drive/MICRODADOS_ENEM_2019.csv',encoding='ISO-8859-1', sep=';', nrows=lines_to_read)
...
plt.title('Maiores Notas por Matéria no ENEM 2019', fontsize=14)
