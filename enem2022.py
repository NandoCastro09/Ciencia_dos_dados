...
Original file is located at
    https://colab.research.google.com/drive/1akAEv_zJavT9cbYd7A7n6MdBhRnDEiAw
"""
...
dados = pd.read_csv('/content/drive/My Drive/MICRODADOS_ENEM_2022.csv',encoding='ISO-8859-1', sep=';')
...
plt.title('Maiores Notas por Matéria no ENEM 2022', fontsize=14)
